...
##############################################################################
class BlurDetection:
    def __init__(self, model_name="resnet", num_classes=5, batch_size=4, num_epochs=50,device="cuda"):
        ...
        # Model Path
        self.PATH = '../model_weights/BlurDetection_ModelWeights_SinlgeGPU_RESNET_MultiClass_DataLoader.pth'
