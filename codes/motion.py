...
from torchio.transforms import RandomMotion, Motion
...
class MotionCorrupter():
    def __init__(self, mode=1, degrees=10, translation=10, num_transforms=2, image_interpolation='linear', norm_mode=0, noise_dir=2, mu=0, sigma=0.1, random_sigma=False, n_threads=4):
        ...
        self.noise_dir = noise_dir #0, 1 or 2 - which direction the motion is generated, only for custom random. 2 TorchIO mode. -1 for random 0 or 1
